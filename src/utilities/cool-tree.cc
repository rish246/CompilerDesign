...
// Provide definitions of dump_Symbol here
void dump_Symbol(ostream &stream, int padding, Symbol s)
{

   stream << pad(padding) << s->getValue();
}
...
// void Program_class::dump(std::ostream &stream, int paddingLen)
// {
//    // program_class inherits tree_node
//    // We should be able to call dump here
//    dump(stream, paddingLen);
// }

// void Formal_class::dump(std::ostream &stream, int paddingLen)
// {
//    // program_class inherits tree_node
//    // We should be able to call dump here
//    dump(stream, paddingLen);
...
// void Class__class::dump(std::ostream &stream, int paddingLen)
// {
//    // program_class inherits tree_node
//    // We should be able to call dump here
//    dump(stream, paddingLen);
// }
// void Expression_class::dump(std::ostream &stream, int paddingLen)
// {
//    // program_class inherits tree_node
//    // We should be able to call dump here
//    dump(stream, paddingLen);
...
// void Case_class::dump(std::ostream &stream, int paddingLen)
// {
//    // program_class inherits tree_node
//    // We should be able to call dump here
//    dump(stream, paddingLen);
